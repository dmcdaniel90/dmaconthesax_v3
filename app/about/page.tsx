                ...
                <section className="relative z-10 pb-20 sm:pb-24 lg:pb-32 xl:pb-40">
                    <div className="container mx-auto px-6 sm:px-8 md:px-12 lg:px-16">
                        <div className="max-w-7xl mx-auto space-y-16 lg:space-y-20">
                                    ...
                                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 min-h-[500px] lg:min-h-[600px]">
                                        ...
                                        <FadeInLeft delay={0.4}>
                                            <div className="relative order-2 lg:order-1">
                                                ...
                                                <div className="w-full h-full aspect-[4/5] md:max-w-[700px] max-h-[875px] lg:min-h-[600px]">
                                                    <ResponsiveImage
                                            ...
                                            <div className="order-1 lg:order-2 flex flex-col justify-center p-8 sm:p-12 lg:p-16">
                                                <StaggerContainer staggerDelay={0.1}>
                                                    <StaggerItem direction="up" delay={0}>
                                                        <div className="text-black inline-block rounded-xl bg-[#F7B478] px-4 py-2 text-sm font-semibold tracking-wider text-[#02ACAC] uppercase border border-[#02ACAC]/30">About DMAC</div>
                                                    </StaggerItem>
                            ...
                            {/* Journey Section */}
                            <FadeInUp delay={0.8}>
                                <div className="bg-gradient-to-br from-gray-900/90 via-gray-800/80 to-gray-900/95 backdrop-blur-xl rounded-3xl shadow-2xl border border-gray-700/20 hover:border-[#02ACAC]/30 transition-all duration-500 hover:shadow-[#02ACAC]/10 p-8 sm:p-12 lg:p-16">
