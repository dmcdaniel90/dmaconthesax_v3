    ...
    return (
        <main className="mt-16 min-h-screen bg-gradient-to-br from-gray-900/70 via-gray-800/70 to-gray-900/70">
                ...
                <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <div className="max-w-4xl mx-auto">
                        ...
                        <p className="text-xl sm:text-2xl lg:text-3xl xl:text-4xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
                            Discover our upcoming shows and past performances
                        </p>
                    </div>
                </div>
            </section>
            ...
            <section className="relative z-10">
                <div className="bg-gradient-to-br from-gray-900/80 via-gray-800/70 to-gray-900/80 backdrop-blur-sm rounded-3xl p-8 sm:p-10 lg:p-12 border border-gray-700/30 shadow-2xl">
