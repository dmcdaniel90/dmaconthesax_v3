...
export default function Booking() {
    ...
    return (
        <main className="mt-16 min-h-screen bg-gradient-to-br from-gray-900/70 via-gray-800/70 to-gray-900/70">
            ...
            <section className="relative z-10 pb-16 sm:pb-20 lg:pb-24">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="max-w-7xl mx-auto">
                        <div className="bg-gradient-to-br from-gray-900/80 via-gray-800/70 to-gray-900/80 backdrop-blur-sm rounded-3xl shadow-2xl border border-gray-700/30 overflow-hidden">
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
                                ...
                                <section className="order-1 lg:order-2 bg-gradient-to-br from-gray-900/90 to-gray-800/70 backdrop-blur-sm py-8 sm:py-10 lg:p-8 xl:p-12 min-h-[600px] lg:min-h-[700px]">
                                    <div className="text-center mb-8 lg:mb-10">
                                        <div className="w-16 h-1 bg-gradient-to-r from-transparent via-[#02ACAC] to-transparent mx-auto mb-4"></div>
